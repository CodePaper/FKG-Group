function [X1 A B cluster center_vector] = Make4(train_data)
        ...
        for h=l+1:r2-3
            for s=h+1:r2-2
                for q=s+1:r2-1
                    dem=0;
                    for t=1:r1
                        if (ruleList1(t,l)==ruleList1(i,l))&(ruleList1(t,h)==ruleList1(i,h))&(ruleList1(t,s)==ruleList1(i,s))&(ruleList1(t,q)==ruleList1(i,q))
                                dem=dem+1;
                        end
                    end
